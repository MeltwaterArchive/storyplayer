...
$story->addAction(function() {
	...
	Asserts::assertsString($stringData)->isNotEmpty();

	// and these should fail
	try {
		$nullData = null;
		Asserts::assertsString($nullData)->isNotEmpty();
	}
	catch (Exception $e) {
	...
	try {
		$arrayData = [];
		Asserts::assertsString($arrayData)->isNotEmpty();
	}
	catch (Exception $e) {
	...
	try {
		$booleanData = true;
		Asserts::assertsString($booleanData)->isNotEmpty();
	}
	catch (Exception $e) {
	...
	try {
		$doubleData = 0.0;
		Asserts::assertsString($doubleData)->isNotEmpty();
	}
	catch (Exception $e) {
	...
	try {
		$intData = 0;
		Asserts::assertsString($intData)->isNotEmpty();
	}
	catch (Exception $e) {
	...
	try {
		...
		Asserts::assertsString($objectData)->isNotEmpty();
	}
	catch (Exception $e) {
