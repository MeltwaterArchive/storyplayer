...
$story->addAction(function() {
	...
	// this should pass
	$stringData = null;
	Asserts::assertsString($stringData)->isNull();

	// and these should fail
	try {
		$arrayData = [];
		Asserts::assertsString($arrayData)->isNull();
	}
	catch (Exception $e) {
	...
	try {
		$booleanData = true;
		Asserts::assertsString($booleanData)->isNull();
	}
	catch (Exception $e) {
	...
	try {
		$doubleData = 0.0;
		Asserts::assertsString($doubleData)->isNull();
	}
	catch (Exception $e) {
	...
	try {
		$intData = 0;
		Asserts::assertsString($intData)->isNull();
	}
	catch (Exception $e) {
	...
	try {
		...
		Asserts::assertsString($objectData)->isNull();
	}
	catch (Exception $e) {
