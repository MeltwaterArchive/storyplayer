...
$story->addAction(function() {
    // what are we doing?
    $log = Log::usingLog()->startAction("make sure that the Shell module sees that process 'php1' is not running on 'localhost'");
    ...
    $isRunning = Host::expectsLocalhost()->processIsNotRunning("php1");
