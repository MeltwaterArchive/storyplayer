...
$story->addAction(function() {
    // what are we doing?
    $log = Log::usingLog()->startAction("make sure that the Shell module sees that Storyplayer is running on 'localhost'");
    ...
    $isRunning = Host::expectsLocalhost()->processIsRunning("php");
