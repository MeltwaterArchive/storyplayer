...
$story->addTestSetup(function() {
    // what are we doing?
    $log = Log::usingLog()->startAction("add some appSettings to 'localhost'");
    ...
    $checkpoint->expectedSettings = $hostDetails->appSettings->zmq->single;
...
$story->addAction(function() {
    // what are we doing?
    $log = Log::usingLog()->startAction("get the appSetting 'zmq.single' for 'localhost'");
    ...
    $checkpoint->actualSettings = Host::fromLocalhost()->getAppSetting("zmq.single");
...
$story->addPostTestInspection(function() {
    // what are we doing?
    $log = Log::usingLog()->startAction("did we get the appSetting for 'localhost'?");
