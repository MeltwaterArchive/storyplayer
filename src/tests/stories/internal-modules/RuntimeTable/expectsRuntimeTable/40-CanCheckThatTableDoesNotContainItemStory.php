...
$story->setScenario([
    ...
    "I can check that an item does not exist inside that table",
]);
...
$story->addAction(function() {
    // what are we doing?
    $log = Log::usingLog()->startAction("check that an item does not exist inside our test table");

    // this is where you perform the steps of your user story
    RuntimeTable::expectsRuntimeTable('functional-tests')->doesNotHaveItem('group2');
