...
$story->addAction(function() {
    // what are we doing?
    $log = usingLog()->startAction("use the Shell module to get our process ID");
    ...
    $checkpoint->actualPid = fromShell()->getPid('php');
...
$story->addPostTestInspection(function() {
    // what are we doing?
    $log = usingLog()->startAction("make sure the Shell module returned the expected PID");
