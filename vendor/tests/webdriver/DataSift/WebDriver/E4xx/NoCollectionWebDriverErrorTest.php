...
class E4xx_NoCollectionWebDriverErrorTest extends PHPUnit_Framework_TestCase
{
	/**
	 * @covers DataSift\WebDriver\E4xx_NoCollectionWebDriverError::__construct
	 */
	public function testCanInstantiate()
	{
	    ...
	    $obj = new E4xx_NoCollectionWebDriverError('oh dear');

	    // ----------------------------------------------------------------
	    // test the results

	    $this->assertTrue($obj instanceof E4xx_NoCollectionWebDriverError);
	}
