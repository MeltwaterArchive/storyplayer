...
class E4xx_TimeOutWebDriverErrorTest extends PHPUnit_Framework_TestCase
{
	/**
	 * @covers DataSift\WebDriver\E4xx_TimeOutWebDriverError::__construct
	 */
	public function testCanInstantiate()
	{
	    ...
	    $obj = new E4xx_TimeOutWebDriverError('oh dear');

	    // ----------------------------------------------------------------
	    // test the results

	    $this->assertTrue($obj instanceof E4xx_TimeOutWebDriverError);
	}
