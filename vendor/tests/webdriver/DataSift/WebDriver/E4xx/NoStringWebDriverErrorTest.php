...
class E4xx_NoStringWebDriverErrorTest extends PHPUnit_Framework_TestCase
{
	/**
	 * @covers DataSift\WebDriver\E4xx_NoStringWebDriverError::__construct
	 */
	public function testCanInstantiate()
	{
	    ...
	    $obj = new E4xx_NoStringWebDriverError('oh dear');

	    // ----------------------------------------------------------------
	    // test the results

	    $this->assertTrue($obj instanceof E4xx_NoStringWebDriverError);
	}
